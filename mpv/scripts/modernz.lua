...
local user_opts = {
	...
	-- Colors and style (Vague theme)
	osc_color = "#1c1c1f", -- accent color of the OSC and title bar
	window_title_color = "#cdcdcd", -- color of the title in borderless/fullscreen mode
	window_controls_color = "#cdcdcd", -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
	windowcontrols_close_hover = "#e78284", -- color of close window control on hover
	windowcontrols_max_hover = "#e5c890", -- color of maximize window controls on hover
	windowcontrols_min_hover = "#a6d189", -- color of minimize window controls on hover
	title_color = "#cdcdcd", -- color of the title (above seekbar)
	cache_info_color = "#7f8490", -- color of the cache information
	seekbarfg_color = "#ef9f76", -- color of the seekbar progress and handle
	seekbarbg_color = "#30303a", -- color of the remaining seekbar
	seekbar_cache_color = "#3c3c47", -- color of the cache ranges on the seekbar
	volumebar_match_seek_color = false, -- match volume bar color with seekbar color (ignores side_buttons_color)
	time_color = "#cdcdcd", -- color of the timestamps (below seekbar)
	chapter_title_color = "#7f8490", -- color of the chapter title (above seekbar)
	side_buttons_color = "#cdcdcd", -- color of the side buttons (audio, subtitles, playlist, etc.)
	middle_buttons_color = "#cdcdcd", -- color of the middle buttons (skip, jump, chapter, etc.)
	playpause_color = "#8caaee", -- color of the play/pause button
	held_element_color = "#252529", -- color of the element when held down (pressed)
	hover_effect_color = "#89dceb", -- color of a hovered button when hover_effect includes "color"
	thumbnail_border_color = "#1c1c1f", -- color of the border for thumbnails (with thumbfast)
	thumbnail_border_outline = "#313244", -- color of the border outline for thumbnails
